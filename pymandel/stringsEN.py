...
INTROTXT = "Welcome to PyMandel! Use mouse wheel or left-click to zoom, right-click to center."

HELPTXT = "Enter settings manually (or import them from a metadata file) and click PLOT to create a fractal image with the specified parameters.\n\n" \
...
ABOUTTXT = "PyMandel is a free, open-source GUI application written entirely in Python and tkinter with Numba performance enhancements.\n\n" \
    +"Version " + VERSION + "\n\n" \
