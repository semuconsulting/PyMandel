...
HELPTXT = "Geben Sie die Einstellungen manuell ein (oder importieren Sie sie aus einer Metadatendatei) und klicken Sie auf ZEICHNEN, um ein Fraktalbild mit den angegebenen Parametern zu erstellen.\n\n" \
...
METASAVEERROR = "FEHLER! Metadatendatei konnte nicht im angegebenen Verzeichnis gespeichert werden"
