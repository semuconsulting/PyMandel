...
**NB**: At time of writing Numba is not officially supported on Python 3.9, so for
...
There are unofficial workarounds available for Python 3.9 e.g. [numba/llvmlite installation workaround](https://stackoverflow.com/questions/65798319/llvmlite-failed-to-install-error-building-llvmlite).
